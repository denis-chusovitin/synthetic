...
DEFINITION_BLOCK_WITH_END {
  $$ = new DefinitionBlocksClass($1, "DEFINITION_BLOCKS");
}
| DEFINITION_BLOCKS '|' DEFINITION_BLOCK_WITH_END {
  $$ = new DefinitionBlocksClass($1, $3, "DEFINITION_BLOCKS");
};

DEFINITION_BLOCK_WITH_END : {
  $$ =
      new DefinitionBlockWithBraceCode(NULL, NULL, "DEFINITION_BLOCK_WITH_END");
}
| DEFINITION_BLOCK {
  $$ = new DefinitionBlockWithBraceCode($1, NULL, "DEFINITION_BLOCK_WITH_END");
}
| DEFINITION_BLOCK BRACE_CODE_TOKEN {
  $$ = new DefinitionBlockWithBraceCode($1, new BraceCode($2),
                                        "DEFINITION_BLOCK_WITH_END");
}
| BRACE_CODE_TOKEN {
  $$ = new DefinitionBlockWithBraceCode(NULL, new BraceCode($1),
                                        "DEFINITION_BLOCK_WITH_END");
};
...
| DEFINITION_BLOCK TOKEN {
  $$ = new DefinitionBlockClass($1, $2, "DEFINITION_BLOCK");
};
